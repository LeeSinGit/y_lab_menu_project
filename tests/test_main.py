...
async def before_and_after_test(clear_cache) -> None:
...
@pytest.fixture(scope='function')
def dish_id(menu_id, submenu_id) -> str:
    data = {
...
class TestMenu:
    ...
    @pytest.mark.order(1)
    def test_get_list_menu(self) -> None:
    ...
    @pytest.mark.order(3)
    def test_get_list_submenu(self, menu_id) -> None:
    ...
    # Создать подменю
    @pytest.mark.order(4)
    def test_create_submenu(self, menu_id) -> None:
        data = {
            'title': f'NEW_TITLE_SUBMENU_PYTEST_{uuid.uuid4()}',
            'description': f'NEW_DESCRIPTION_SUBMENU_PYTEST_{uuid.uuid4()}'
        }
    ...
    @pytest.mark.order(5)
    def test_get_list_dish(self, menu_id, submenu_id) -> None:
        response = client.get(
    ...
    # Создать блюдо
    @pytest.mark.order(6)
    def test_create_dish(self, menu_id, submenu_id) -> None:
        data = {
    ...
    # Обновляет меню
    @pytest.mark.order(7)
    def test_update_current_menu(self, menu_id) -> None:
    ...
    # Обновляет подменю
    @pytest.mark.order(8)
    def test_update_submenu(self, menu_id, submenu_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
    ...
    # Обновить блюдо
    @pytest.mark.order(9)
    def test_update_dish(self, menu_id, submenu_id, dish_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
        assert submenu_id is not None, 'ID подменю не был сохранен'
    ...
    def test_get_target_menu(self, menu_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
    ...
    def test_get_list_menu_not_empty(self) -> None:
        response = client.get(f'/{self.url}/')
        assert response.status_code == 200
        assert (
            response.json() != []
    ...
    def test_get_target_submenu(self, menu_id, submenu_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
        assert submenu_id is not None, 'ID подменю не был сохранен'
    ...
    def test_get_list_submenu_not_empty(self, menu_id) -> None:
        response = client.get(f'/{self.url}/{menu_id}/submenus')
        assert response.status_code == 200
        assert (
            response.json() == []
    ...
    def test_get_target_d(self, menu_id, submenu_id, dish_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
        assert submenu_id is not None, 'ID подменю не был сохранен'
        assert dish_id is not None, 'ID блюда не был сохранен'
    ...
    def test_delete_dish(self, menu_id, submenu_id, dish_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
        assert submenu_id is not None, 'ID подменю не был сохранен'
        assert dish_id is not None, 'ID блюда не был сохранен'
    ...
    def test_delete_submenu(self, menu_id, submenu_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
        assert submenu_id is not None, 'ID подменю не был сохранен'
    ...
    def test_delete_menu(self, menu_id) -> None:
        assert menu_id is not None, 'ID меню не был сохранен'
